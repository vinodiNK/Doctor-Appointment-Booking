...
const MyProfile = () => {
  ...
  const [image, setImage] = useState(false) // Set default to null
  ...
  const updateUserProfileData = async () => {
    try {
      ...
      formData.append('address', JSON.stringify(userData.address)) // Ensure address is JSON
      ...
      {isEdit ? 
        <label htmlFor="image">
          <div className='inline-block relative cursor-pointer'>
            ...
            <img className='w-10 absolute bottom-12 right-12' src={image ? '' : assets.about_image} alt="" />
          </div>
